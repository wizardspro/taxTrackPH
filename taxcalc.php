    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="taxcalc.html">Module 1</a></li>
        ...
        <div class="container" id="site_content">
            ...
            <div class="row" id="form_ECI">
                <fieldset class="col-md-8 col-md-offset-2 panel panel-default" >
                    <legend>
                        <div id="form_legend">Earning Compensation Income</div>
                    </legend>
                    <form class="form-horizontal" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input class="form-control" onkeyup="update()" onchange="update()" 
                                    id="gross_income" type="number" min="60000" step="1"
                                    value="60000"
                                    name="gross_income " >
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input class="form-control" disabled
                                    ...
                                    name="basic_personal_exemption" value="50000">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="additional_exemption_radio" class="col-md-5 control-label">Additional exemption</label>
                            <div class="col-md-7">
                                <input id="additional_exemption_radio_0" type="radio"
                                    onclick="update()"
                                    name="additional_exemption_radio" checked> 0
                                <input id="additional_exemption_radio_1" type="radio"
                                    onclick="update()"
                                    name="additional_exemption_radio" value=""> 1
                                <input id="additional_exemption_radio_2" type="radio"
                                    onclick="update()"
                                    name="additional_exemption_radio" value=""> 2
                                <input id="additional_exemption_radio_3" type="radio"
                                    onclick="update()"
                                    name="additional_exemption_radio" value=""> 3
                                <input id="additional_exemption_radio_4" type="radio"
                                    onclick="update()"
                                    name="additional_exemption_radio" value=""> 4
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="basic_personal_exemption"
                                class="col-md-5 control-label">
                            Total additional exemption
                            </label>
                            <div class="col-md-7">
                                <input class="form-control" disabled
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input class="form-control" onkeyup="update()" onchange="update()"
                                    id="phhi" 
                                    type="number" step="1" min='0' max="2400" value='0' name="phhi">
                            </div>
                        </div>
                        <div class="form-group">
            ...
            <ul class="nav nav-tabs nav-justified" style="margin-top:80px;">
                <li class="active">
                ...
                <li>
                    <a href="#bydepartment"  data-toggle="tab">By Department</a>
                </li>
            </ul>
                    ...
                    <table class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="col-md-2 text-center">Percent</th>
                                <th class="col-md-3 text-right">Budget</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                ...
                <div class="tab-pane" id="bydepartment">
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Department of Transportation and Communications</td>
                            ...
                            <tr>
                                <td>Joint Legislative-Executive Councils</td>
                            ...
                            <tr>
                                <td>Budgetary Support to Government Corporations(BSGC)</td>
                                <td align="center">(3.16%)</td>
                                <td align="right" id="BSGC">P 0</td>
                            </tr>
                            <tr>
                                <td>Allocations to Local Government Units</td>
                            ...
                            <tr>
                                <td>Miscellaneous Personnel Benefits Fund(MPBF)</td>
                            ...
                            <tr>
                                <td>Priority Development Assistance Fund(PDAF)</td>
